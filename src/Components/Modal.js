...
function Modal({ closeModal }) {
  ...
  return (
    <div>
      ...
      <div className="absolute inset-x-0 top-36 m-auto w-1/2 bg-[#F6F8FA] dark:bg-white rounded-md ">
       ...
       <h1 className="text-2xl text-gitdark font-bold text-center">Customize Your view</h1>
  ...
  <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
       ...
       <p className="text-center m-2 text-2xl font-extrabold">Choose which colors suits you the most.</p>
       <div className="flex justify-center items-center m-2">
         <button className="btn bg-indigo-500 hover:bg-indigo-700 h-12 rounded-lg shadow-lg" onClick={closeModal}>Done</button>
       </div>
      </div>
    </div>
  );
